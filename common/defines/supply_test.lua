...
-- 海軍基地が1.12で大幅弱体化されたので対応しつつも強化
NDefines.NSupply.NAVAL_FLOW_PER_LEVEL = 5.0 -- 15.0
NDefines.NSupply.NAVAL_BASE_FLOW = 5.0 --5.0
...
-- 人口による補給の弱体化
NDefines.NSupply.NON_CORE_MANPOWER_STATE_SUPPLY = 0.1 -- 0.2
NDefines.NSupply.AVAILABLE_MANPOWER_STATE_SUPPLY = 0.10 -- 0.18